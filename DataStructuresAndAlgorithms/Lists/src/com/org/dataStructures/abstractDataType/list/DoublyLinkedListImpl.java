...
public class DoublyLinkedListImpl {
	...
	public static void main(String[] args) {
		...
		employeeList.addBefore(new Employee("Bangaram","Konda",5), new Employee("Run", "Ya", 2));
		
		System.out.println("\n After addition of bangaram: ");
		employeeList.printList();
		System.out.println("\n Size - "+employeeList.getSize());
		
		System.out.println("Before addition of Ashish: ");
		System.out.println("Size - "+employeeList.getSize());
		employeeList.printList();
		employeeList.addAfter(new Employee("Ashish","Sirigiri",5), new Employee("Shas", "Runs", 3));
		
		System.out.println("\n After addition of Ashish: ");
		employeeList.printList();
		System.out.println("\n Size - "+employeeList.getSize());
